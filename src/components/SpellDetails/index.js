    ...
    return (
        <MainContainer>
            <MainDetailContainer>
                ...
                <Description key={index} dangerouslySetInnerHTML={{ __html: desc.replace(/\*\*\*(.*?)\*\*\*/g, '<strong>$1</strong>') }} />
                ))}
                {spell.higher_level.length > 0 ? (<Description><strong>At Higher Levels.</strong>
